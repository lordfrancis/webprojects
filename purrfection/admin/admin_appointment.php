        ...
        <nav class="navbar navbar-dark border-primary border rounded-0 align-items-start sidebar sidebar-dark accordion p-0" style="background-color: #feae11;">
            <div class="container-fluid d-flex flex-column p-0">
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>Veterinarian</span></div>
                </a>
                <hr class="sidebar-divider my-0">
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="admin_dashboard.html"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="admin_appointment.php"><i class="fas fa-table"></i><span>Appointments</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link" href="admin_consultation.php"><i class="fas fa-table"></i><span>Consultation and&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Vaccination</span></a></li>
                    <li class="nav-item"
                        role="presentation"><a class="nav-link" href="../logout.php"><i class="far fa-user-circle"></i><span>Logout</span></a></li>
                </ul>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                      ...
                      </div><button class="btn btn-warning d-inline-block float-right" type="button" 
                             style="margin-left: 10px;" id="cancelBtn">Cancel Appointment</button>
                        <button class="btn btn-success d-inline-block float-right" type="button" data-toggle="modal" href="#modal1">Add Appointment</button>
        ...
        <div class="modal fade" role="dialog" tabindex="-1" id="modal1">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer"><button class="btn btn-danger" type="button" data-dismiss="modal">Cancel</button><button class="btn btn-primary" id="addNewAppointmentBtn" name="addNewAppointmentBtn" type="button" onclick="addNewAppointment()">Add New Appointment</button>
