        ...
        <nav class="navbar navbar-dark border-primary border rounded-0 align-items-start sidebar sidebar-dark accordion p-0" style="background-color: #feae11;">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="admin_appointment.php"><i class="fas fa-table"></i><span>Appointments</span></a></li>
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="admin_consultation.php"><i class="fas fa-table"></i><span>Consultation and&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Vaccination</span></a></li>
                    <li class="nav-item"
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        </div><button class="btn btn-success d-inline-block float-right" type="button" style="margin-left: 10px;" name="viewPetsBtn" id="viewPetsBtn">View Pets</button>
          ...
          $('#viewPetsBtn').click( function () {
                ...
                var idString = rowData[0].toString();
                 ...
                 console.log(typeof idString);
                  ...
                  window.open("admin_userpets.php?id="+ idString, "_self");
         });
