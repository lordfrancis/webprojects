...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Add Consultation Details</h3>

                <form action="addConsultation.php" onsubmit="addNewConsultation()" name="addconsultationform" id="addconsultationform" method="POST">
                    ...
                    <input type="hidden" id="petId" name="petId" value="<?php echo $_GET['id']; ?>">
                      ...
                      <button type="submit" class="btn btn-primary mb-2">Add Consultation</button>
                </form>
            </div>
        </div>
    ...
    function addNewConsultation(){
        ...
        alert("Consultation Record  Successfully Added!");
        document.getElementById("addconsultationform").submit();
    }
