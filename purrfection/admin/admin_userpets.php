            ...
            <div class="container-fluid">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                      ...
                      </div><button class="btn btn-warning d-inline-block float-right" type="button" style="margin-left: 10px;" name="viewBtn" id="viewBtn">View Information</button>
    ...
    <script>
        ...
        if ( $(this).hasClass('selected') ) {
         ...
         $('#viewBtn').click( function () {
            ...
            window.open("admin_petInfo.php?id="+ idString, "_self");
