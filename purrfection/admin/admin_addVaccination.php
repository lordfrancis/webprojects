...
<body id="page-top">
    <div id="wrapper">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4">Add Vaccination Details</h3>

                <form action="addVaccination.php" onsubmit="addNewVaccination()" name="addvaccinationform" id="addvaccinationform" method="POST">
                    
                    <input type="hidden" id="petId" name="petId" value="<?php echo $_GET['id']; ?>">
                      <div class="form-group">
                        <label for="exampleFormControlTextarea1">Vaccine Type</label>
                        <select name="vaccine" class="form-control">
                            <option>Select a vaccine type</option>
                            ...
                            <option value="Canine Leptospira">Canine Leptospira</option>
                            <option value="Canine parainfluenza virus (CPi)">Canine parainfluenza virus (CPi)</option>
                            <option value="Bordetella bronchiseptica">Bordetella bronchiseptica</option>
                            <option value="Canine Rabies">Canine Rabies</option>
                        </select>
                      </div>

                      <div class="form-group">
                        <label for="exampleFormControlTextarea1">Remarks/Recommendations</label>
                        <textarea class="form-control" id="remarks" name="remarks" rows="3"></textarea>
                      </div>

                      <button type="submit" class="btn btn-primary mb-2">Add Vaccination</button>
                </form>
            </div>
        </div>
    ...
    function addNewVaccination(){
        alert("Vaccination Details Successfully Added!");
        document.getElementById("addvaccinationform").submit();
    }
    </script>
</body>
